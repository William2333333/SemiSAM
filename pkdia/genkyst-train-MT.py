...
from manage.manage_genkyst import genksyt_split, create_genkyst_dataset_MT
from datasets.dataset_genkyst import dataset_genkyst_MT
import argparse
import logging
import sys
import os
...
def get_args():
    ...
    parser.add_argument('-b', '--batch', type=int, default=8, dest='batch') # 4 # 3 
    ...
    parser.add_argument('-n', '--network', type=int, default=27, dest='network') # 25 # 22
    
    parser.add_argument('-s', '--size', type=int, default=256, dest='size')
    
    parser.add_argument('-g', '--gamma', type=int, default=5, dest='gamma') # 5
